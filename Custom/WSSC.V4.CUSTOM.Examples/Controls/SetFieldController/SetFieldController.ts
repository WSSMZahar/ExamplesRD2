...
function FOS_SetFieldController() {
    var controller: IField = ListForm.GetField(FOS_ControllerFieldName, true);
    if (controller == null)
        return;

    var onControl: IField = ListForm.GetField(FOS_OnControlFieldName, true);
    if (onControl == null)
        return;
    ...
    var value: boolean = controllerValue == null || controllerValue.LookupID != 0;
